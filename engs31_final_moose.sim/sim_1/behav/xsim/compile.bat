...
REM
REM Generated by Vivado on Tue May 21 13:41:59 -0400 2024
...
echo "xvhdl --incr --relax -prj TopShell_tb_vhdl.prj"
call xvhdl  --incr --relax -prj TopShell_tb_vhdl.prj -log xvhdl.log
